...
class ParseTests: XCTestCase {
    ...
    func testComputeSum() {
        let input = readFile("Resources/01/test-input1.txt")
    ...
    func testComputeSumWithText() {
        let input = readFile("Resources/01/test-input2.txt")
        let output = computeSum(input)
        XCTAssertEqual(281, output)
    }

    func testProper() {
        let input = readFile("Resources/01/input1.txt")
        print(computeSum(input))
    }

    func test2() {
          let input = readFile("Resources/01/input2.txt")
        print(computeSum(input))
    }
